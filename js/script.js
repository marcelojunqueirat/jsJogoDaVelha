...
/* contador de jogadas (saber de quem é a vez de jogar) */
let player1 = 0;
let player2 = 0;
...
// evento para saber se é dois player ou IA
...
function computerPlay(){
    ...
    for(let i = 0; i < boxes.length; i++){
        ...
        // so vou preencher se o filho estiver vazio
        if(boxes[i].childNodes[0] == undefined){
            if(ramdomNumber <= 1){
